...
export const Hero = () => {
  return <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-stellar bg-clip-text text-transparent animate-fade-in">A.M.A.N.D.A.</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-scale-in">
          <a href="#method-selector" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-stellar text-foreground rounded-lg font-semibold shadow-glow-primary hover:shadow-glow-secondary transition-all hover:scale-105">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-primary rounded-full animate-float" style={{
        animationDelay: '0s'
      }} />
        <div className="absolute top-1/3 right-1/3 w-1 h-1 bg-secondary rounded-full animate-float" style={{
        animationDelay: '1s'
      }} />
        <div className="absolute bottom-1/4 right-1/4 w-2 h-2 bg-primary rounded-full animate-float" style={{
        animationDelay: '2s'
      }} />
      </div>
    </section>;
